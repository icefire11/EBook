...
<div class="container clearfix">
   ...
   %>
      ...
      <input name="fukuan" type="submit"  value="删除" style="background-color:pink; " >
                    ...
                    <input style= "width:100px;height:50px;color:white;background-color:#FFBBF1;" type="button" id="start_feature" value="添加用户"onclick="window.location.href='tianjiayonghu.jsp?'" />
                </div>
        </div>
    </div>
    <!--/main-->
