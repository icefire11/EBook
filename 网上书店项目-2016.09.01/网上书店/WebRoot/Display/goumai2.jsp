...
<div style="position:absolute; margin:420 1 2 500">
           <textarea name="pinglunxinxi" id="aa" rows="6" placeholder="已经评论，请不要重复评论！！！！"></textarea>
            </div>
<div style="position:absolute;margin:520 1 1 500">
<input style= "width:80px;height:30px;color:black;background-color:yellow;" type="submit" value="已经评论" />
	 </div> 
	 </form>
