...
<html>
  ...
  Class.forName("com.mysql.jdbc.Driver");
		...
		String name2 = new String(request.getParameter("bookname").getBytes("ISO-8859-1"),"GBK");
	session.setAttribute("bookname2", name2);
      String sql = "select * from bookxinxi where bookname='" + name2
      + "'";       
...
<div style="position:absolute; margin:420 1 2 500">
           <textarea name="pinglunxinxi" id="aa" rows="6" placeholder="你还没购买，不能评论！！！！"></textarea>
            </div>
...
<form method="post" name="frmLogin" action="gouwuche.action">
 <div style="position:absolute;margin:600 1 1 500">
           ...
           <input type="text" name="bookname" value="<%=name2%>"  style="display:none;"/>
 ...
 <input style= "width:100px;height:50px;color:white;background-color:#FFBBF1;" type="button" id="start_feature" value="一键购买"onclick="window.location.href='Display/pay.jsp?'" />
 </div> 
