...
<div class="container">
  <div class="header"style="background-color: #C6D580; display:block;margin-top:20px;" />  
  <div align="center">
  <div style="align:left;font-size:50px;">留言板</div>
  <form name="form1" method="post" action="liuyan.action">
  <input type="text" name="username" value="<%=session.getAttribute("username") %>"  style="display:none;"/>
 <input type="text" name="liuyan" placeholder="请输入你的留言" style="width:500px;height:100px;"  required/>
...
<!-- end .sidebar1 --></div>
  <div class="content">
    ...
    <%while(rs.next()) {
      %>
         <div style=" font-size:15px;font-family:SimHei;color:red">
         <%
         out.print("评论("+n+"):");
         %>
         </div>
    ...
    <!-- end .content --></div>
  <div class="footer">
    <p align="center">本网站制作人：张家旗，张政，田苗，朱钢。感谢您对张田钢书店的支持！ </p>
    <!-- end .footer --></div>
  <!-- end .container --></div>
</body>
</html>
