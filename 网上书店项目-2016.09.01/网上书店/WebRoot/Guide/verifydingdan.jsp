...
<body>
   ...
   <%
    ...
    ResultSet rs = stmt.executeQuery ( sqll );
      if(rs.next()) 
      { 
    String sql= "insert into dingdan1 (dingdanhao,name,zhifubao,zhifubaomima,address,bookname,shuming,tupianlujing,price,author) values ('" + sdf.format(d)   + "','"  +session.getAttribute("username")+"','" +snumber + "','" + sPasswd+ "','" + sAdd +"','"+ session.getAttribute("bookname2")+"','" + rs.getString(1)+"','" + rs.getString(2)+"','"+ rs.getString(3)+"','"+ rs.getString(4)+"')";   
